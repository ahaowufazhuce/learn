...
<div class="container">
    <form class="form-signin" action="/user/register">
        ...
        <input type="name" id="inputName" name="name" class="form-control" placeholder="请输入用户名" required>
        <label for="inputPhoneNumber" class="sr-only">phoneNumber</label>
        <input type="phoneNumber" id="inputPhoneNumber" name="phoneNumber" class="form-control" placeholder="请输入手机号" required>
